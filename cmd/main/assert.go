...
func AsserErrorEqualsAny(t *testing.T, expectAnyIn []error, got error) {
...
func AssertMapsEqual(t *testing.T, expected, got map[string]interface{}) {
	// Create new maps
...
func AssertStringArraysEqualNoOrder(t *testing.T, expected, got []string) {
